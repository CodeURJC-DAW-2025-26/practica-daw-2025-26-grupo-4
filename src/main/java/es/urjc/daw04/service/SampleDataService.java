...
public class SampleDataService {
    ...
    public void init() {
        ...
        Category catTools = categories.stream().filter(c -> c.getName().equals("Herramientas")).findFirst().orElse(null);
        ...
        if (orderService.findAll().isEmpty()) {
            ...
            if (products.size() >= 2 && userNormal != null) {
                ...
                orderPrueba.setStatus(EnumStatus.DELIVERED); // Para que pueda escribir reviews
